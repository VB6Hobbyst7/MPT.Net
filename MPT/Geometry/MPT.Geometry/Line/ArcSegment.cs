...
namespace MPT.Geometry.Line
{
    ...
    public class ArcSegment : PathSegment, ICurve, IPathDivision, IPolarCoordinates
    {
        ...
        public ArcSegment(Point i, Point j) : base(i, j) { }
        #endregion
        ...
        public Point PointByPathPositionPolar(double theta)
        {
            throw new NotImplementedException();
        }

        public Point NormalVectorPolar(double theta)
        {
            throw new NotImplementedException();
        }

        public Point TangentVectorPolar(double theta)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="centerSeparation">Separation between the centers of the two circles.</param>
        /// <returns></returns>
        public static Point CirclesIntersect(double radius1, double radius2, double centerSeparation)
        {
            return new Point(
        ...
        public static double[] CircleLineIntersectX(Point point1, Point point2, double radius)
        {
        ...
        /// <param name="point2">Second point forming the line.</param>
        /// <param name="radius">Radius of the circle centered at 0,0.</param>
        public static double[] CircleLineIntersectY(Point point1, Point point2, double radius)
        {
            Offset delta = new Offset(point1, point2);
            double determinant = point1.CrossProduct(point2);
            double lineLength = Algebra.SRSS(delta.X(), delta.Y());
        ...
        public static bool AreCircleLineIntersecting(Point point1, Point point2, double radius, double tolerance = GL.ZeroTolerance)
        {
        ...
        public static bool AreCircleLineTangent(Point point1, Point point2, double radius, double tolerance = GL.ZeroTolerance)
        {
        ...
        private static double incidenceLineCircle(Point point1, Point point2, double radius)
        {
            double determinant = point1.CrossProduct(point2);
