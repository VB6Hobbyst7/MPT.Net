...
''' <summary>
''' This module contains procedures using libraries specific to WinForms. Use these sparingly in this project. There are namespace ambiguities with other System.Windows namespaces needed for a WPF project 
''' </summary>
...
Module mWinForms
    ...
    ' ''' <remarks></remarks>
    'Function BrowseForFilesWinForm(ByRef pathsList As List(Of String), ByVal ftype As String, Optional ByVal dirPath As String = "") As Boolean
    ...
    '            Next
    '            'pathsList = CType(FName, List(Of String))
    '            BrowseForFilesWinForm = True
    '            'j = UBound(CType(FName, Array))   'Determines the number of files selected
    '        End If
    ...
    'Function BrowseForFileWinForm(ByRef myPath As String, ByVal ftype As String, Optional ByVal dirPath As String = "") As Boolean
    '    Dim diaFolder As New System.Windows.Forms.OpenFileDialog
    ...
    ' ''' <remarks></remarks>
    'Sub BrowseForFolderWinForm(Optional ByVal description As String = "", Optional ByVal startupDir As String = "")
