...
''' Originally used for filtering keywords for model selection in the older Excel project.
''' </summary>
''' <remarks></remarks>
Module tbaFilterModelList
    Dim keywordsFilter As New cKeywordsFilters
    Dim rowGlobal As Long
    Dim xmlDoc As Xml.XmlDocument

    Dim myProgramsList() As String
    Dim runTimeList() As String
    Dim classificationList() As String
    Dim keywordsList() As String
    Dim keywordsNotList() As String

    Dim skipCheck As Boolean
    Dim selectModel As Boolean
    Dim duplicateText As Boolean
    Dim SName As String
    ...
    Sub listModelXMLbyFilter()
        ...
        path = keywordsFilter.pathModels
    ...
    Sub searchAllModelXMLsKeywords(ByVal SourceFolderName As String, ByVal IncludeSubfolders As Boolean, ByRef rowGlobal As Long, ByVal colMax As String)
        ...
        If Not IO.Directory.Exists(SourceFolderName) Then Exit Sub
    ...
    Sub readModelXMLKeywords(ByVal PathName As String, Optional ByRef rowGlobal As Long = 0)
        ' TODO: Commented out due to elimination of global xmlRoot object
        'Dim i As Long
        'Dim k As Long
    ...
    Sub readModelXMLbyFilter(ByVal PathName As String, Optional ByRef rowGlobal As Long = 0)
        ...
        ''Filter by Program
        'getKeywords("filter_program", myProgramsList)
        ...
        '    Select Case keywordsFilter.filter_keyword_select
    ...
    Sub getKeywords(ByVal keywordCell As String, ByRef arrayList() As String)
        ...
        While Not cellBlank
            ...
            If cellText = "~ Click for Next Item" Then     'Checks for blank cell, or interactive cell at bottom of keyword column
                cellBlank = True
    ...
    Sub addSelectedCellsRegTest()
        ...
        While Not cellBlank
            ...
            If String.IsNullOrEmpty(cellText) Then ' Stops checking cells at the end of the models list
                cellBlank = True
            Else
