...
''' <summary>
''' XML Node from the file read, including other properties describing its location, children, etc. Can be used to make a virtual class of the XML file. Additional properties allow display in the XML editors.
''' </summary>
''' <remarks></remarks>
...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property xmlChildren As ObservableCollection(Of cXMLNode)
    ''' <summary>
    ...
    Friend Property readWriteAction As eReadWriteConversion
...
#Region "Initialization"
    ...
    Private Sub InitializeData()
        xmlChildren = New ObservableCollection(Of cXMLNode)
    End Sub
