...
#Region "Initialization"
    ...
    Friend Sub New(ByVal p_xmlNodeItem As cXMLNode)
    ...
    Friend Sub New(ByVal p_nodePath As String,
...
#Region "Methods: Friend"
    Friend Overloads Sub ReadWriteAction(ByRef p_readWriteValue As String,
        ...
        End If
    End Sub
    Friend Overloads Sub ReadWriteAction(ByRef p_readWriteValue As Boolean,
                                          Optional ByVal p_xmlNodeItem As cXMLNode = Nothing,
                                          Optional ByVal p_isReading As Boolean = True)
        If p_isReading Then
            ReadAction(p_readWriteValue, p_xmlNodeItem)
        ...
        End If
    End Sub
    Friend Overloads Sub ReadWriteAction(ByRef p_readWriteValue As Integer,
                                            Optional ByVal p_xmlNodeItem As cXMLNode = Nothing,
                                            Optional ByVal p_isReading As Boolean = True)
        If p_isReading Then
            ReadAction(p_readWriteValue, p_xmlNodeItem)
        ...
        End If
    End Sub
    Friend Overloads Sub ReadWriteAction(ByRef p_readWriteValue As ObservableCollection(Of String),
                                          Optional ByVal p_xmlNodeItem As cXMLNode = Nothing,
                                          Optional ByVal p_isReading As Boolean = True)
        If p_isReading Then
            ReadAction(p_readWriteValue, p_xmlNodeItem)
        ...
        End If
    End Sub
    Friend Overloads Sub ReadWriteAction(Of TEnum)(ByRef p_readWriteValue As TEnum,
                                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing,
                                                    Optional ByVal p_isReading As Boolean = True)
        If p_isReading Then
            ReadAction(p_readWriteValue, p_xmlNodeItem)
    ...
    Friend Overloads Sub ReadAction(ByRef p_readValue As String,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        ...
        End Select
    End Sub
    Friend Overloads Sub ReadAction(ByRef p_readValue As Boolean,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
        ...
        End Select
    End Sub
    Friend Overloads Sub ReadAction(ByRef p_readValue As Integer,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)

        If _xmlNodeItem.readWriteAction = eReadWriteConversion.convertInteger Then p_readValue = myCInt(ReadFromSingleNode())
    End Sub
    Friend Overloads Sub ReadAction(Of TEnum)(ByRef p_readValue As TEnum,
                                                Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
    ...
    End Sub
    Friend Overloads Sub ReadAction(ByRef p_readValue As ObservableCollection(Of String),
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
    ...
    Friend Overloads Sub WriteAction(ByVal p_writeValue As String,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
        ...
        End Select
    End Sub
    Friend Overloads Sub WriteAction(ByVal p_writeValue As Boolean,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
        ...
        End Select
    End Sub
    Friend Overloads Sub WriteAction(ByVal p_writeValue As Integer,
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
    ...
    End Sub
    Friend Overloads Sub WriteAction(Of TEnum)(ByVal p_writeValue As TEnum,
                                Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
        Dim xmlNodeItem As cXMLNode = SetXMLNodeItem(p_xmlNodeItem)
    ...
    End Sub
    Friend Overloads Sub WriteAction(ByVal p_writeValue As ObservableCollection(Of String),
                                    Optional ByVal p_xmlNodeItem As cXMLNode = Nothing)
    ...
    Friend Sub SetInstructions(ByVal p_nodePath As String,
                                  Optional ByVal p_nodeAttribute As String = "",
                                  Optional ByVal p_readWriteType As eReadWriteConversion = eReadWriteConversion.readWriteOnly,
                                  Optional ByVal p_readOnly As Boolean = False,
                                  Optional ByVal p_defaultValue As String = "",
...
#Region "Methods: Private"
    ...
    Private Function ConvertToObservableCollection() As ObservableCollection(Of String)
        ...
        For Each childNode As cXMLNode In _xmlNodeItem.xmlChildren
            ...
            nodesList.Add(ReadNodeText(childNode.xmlPath, pathAttribute))
        Next
    ...
    Private Sub ConvertFromObservableCollection(ByVal p_values As ICollection(Of String))
        ...
        For Each childNode As cXMLNode In _xmlNodeItem.xmlChildren
            ...
            WriteNodeText(p_values(i), pathAttribute)
            i += 1
        Next
    End Sub
    ...
    Private Function ConvertFromListToObservableCollection() As ObservableCollection(Of String)
        ...
        ReadNodeListText(_pathNode, nodesList, _attributeName)
    ...
    Private Sub ConvertToListFromObservableCollection(ByVal p_values As ICollection(Of String))
        If p_values.Count > 0 Then
            ...
            WriteNodeListText(p_values.ToArray, _pathNode, parentNodeName)
        End If
    End Sub
    ...
    Private Function ConvertFromUniqueListToObservableCollection() As ObservableCollection(Of String)
        ...
        nodesList = ReadUniqueList(GetPathNodeStub())
    ...
    Private Sub ConvertToUniqueListFromObservableCollection(ByVal p_values As ICollection(Of String))
        ...
        WriteUniqueList(GetPathNodeStub(), subNodeName, p_values)
    End Sub

    Private Function ConvertFromPathListStoredKnown() As ObservableCollection(Of String)
        Dim nodesList As New ObservableCollection(Of String)

        nodesList = ReadNodeListPath(GetPathNodeStub())
    ...
    Private Sub ConvertToPathListStoredKnown(ByVal p_values As ICollection(Of String))
        ...
        WriteNodeListPath(GetPathNodeStub(), subNodeName, p_values)
    End Sub
    ...
    Private Function ReadFromSingleNode() As String
        Return ReadNodeText(_pathNode, _attributeName)
    End Function
    Private Sub WriteToSingleNode(Optional ByVal p_value As String = "")
        ...
        WriteNodeText(writeValue, _pathNode, _attributeName)
    End Sub
#End Region
