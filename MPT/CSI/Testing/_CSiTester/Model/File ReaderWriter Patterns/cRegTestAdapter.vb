...
''' <summary>
''' Handles all actions of reading/writing from/to files associated with the RegTest class.
''' </summary>
''' <remarks></remarks>
Public Class cRegTestAdapter
#Region "Enumerations"
    ''' <summary>
...
#Region "Methods: Friend"
    ...
    Friend Sub Write(ByVal p_defaultValue As eReadWriteAction,
                 Optional ByVal p_path As String = "")
        If (p_defaultValue = eReadWriteAction.writeAll) Then

            ReadWriteToFromFile(p_defaultValue)
        End If
    End Sub
#End Region
