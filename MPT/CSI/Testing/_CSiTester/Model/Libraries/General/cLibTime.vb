...
''' </summary>
''' <remarks></remarks>
Public NotInheritable Class cLibTime
...
#Region "Methods"
    ...
    ''' <remarks></remarks>
    Public Shared Function ConvertTimesNumber(ByVal timeHHMMSS As String) As Long
    ...
    ''' <remarks></remarks>
    Public Shared Function ConvertTimesString(ByVal timeSeconds As Double) As String
    ...
    ''' <returns>Time in seconds</returns>
    ''' <remarks></remarks>
    Public Shared Function ConvertTimesNumberMinute(ByVal timeHHMMSS As String) As Double
        Dim hourSeconds As Long
        Dim minuteSeconds As Long
    ...
    ''' <returns>Time in HH:MM:SS format</returns>
    ''' <remarks></remarks>
    Public Shared Function ConvertTimesStringMinutes(ByVal timeMinutes As Double) As String
        Dim hourHour As String
        Dim minuteMinute As String
        Dim secondSeconds As String
        Dim timeNum As Double
