...
''' </summary>
''' <remarks></remarks>
Public NotInheritable Class cLibFilesXML
...
#Region "Properties"
    Public Shared Property xmlDoc As XmlDocument    'Duplicate in mVariablesFriend that is currently commented out
    Public Shared Property xmlRoot As XmlElement    'Duplicate in mVariablesFriend that is currently commented out
    Public Shared Property myXMLNode As XmlNode    'Duplicate in mVariablesFriend that is currently commented out
    Public Shared Property myXMLObject As XmlNode
    Public Shared Property myXMLAttribute As XmlAttribute
...
#Region "XML Read/Write Master Functions"
    ...
    ''' <remarks></remarks>
    Public Shared Function InitializeXML(ByVal p_path As String,
    ...
    ''' <remarks></remarks>
    Public Shared Sub SaveXML(ByVal p_path As String,
    ...
    ''' <remarks></remarks>
    Public Shared Sub ClearObjects(ByVal p_pathNode As String,
...
#Region "Get XML/Node Information"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ChildCount(ByVal myPath As String) As Integer
        Try
            'Create an XmlNamespaceManager for resolving namespaces.
            Dim nsmgr As New XmlNamespaceManager(xmlDoc.NameTable)
            nsmgr.AddNamespace("n", xmlDoc.DocumentElement.NamespaceURI)
    ...
    ''' <remarks></remarks>
    Public Shared Function CountChildNodes(ByVal pathNode As String) As Integer
        Dim i As Integer
    ...
    ''' <remarks></remarks>
    Public Shared Function XMLChildCount(ByVal myNode As XmlNode) As Integer
        'Counts children based on 3 cases
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function NodeExists(ByVal pathNode As String) As Boolean
        Try
            'Create an XmlNamespaceManager for resolving namespaces.
            Dim nsmgr As New XmlNamespaceManager(xmlDoc.NameTable)
            nsmgr.AddNamespace("n", xmlDoc.DocumentElement.NamespaceURI)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function AttributeExists(ByVal node As XmlNode, ByVal pathNodeAttrib As String) As Boolean
...
#Region "Reading/Writing Nodes"
    ...
    ''' <remarks></remarks>
    Public Shared Function ReadNodeText(ByVal pathNode As String, Optional ByVal pathNodeAttrib As String = "") As String
        Try
            'Create an XmlNamespaceManager for resolving namespaces.
            Dim nsmgr As New XmlNamespaceManager(xmlDoc.NameTable)
            nsmgr.AddNamespace("n", xmlDoc.DocumentElement.NamespaceURI)
    ...
    ''' <remarks></remarks>
    Public Shared Sub WriteNodeText(ByVal p_propValue As String,
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadChildText(ByVal pathNode As String, ByVal childNum As Integer, ByVal childChildNum As Integer) As String
        Try
            'Create an XmlNamespaceManager for resolving namespaces.
            Dim nsmgr As New XmlNamespaceManager(xmlDoc.NameTable)
            nsmgr.AddNamespace("n", xmlDoc.DocumentElement.NamespaceURI)
    ...
    ''' <remarks></remarks>
    Public Shared Sub GetSingleXMLNodeValue(ByVal myPath As String, ByVal myPathNode As String, ByRef myNodeValue As String, Optional ByVal myPathNodeAttrib As String = "", Optional ByVal cleanPath As Boolean = False)
    ...
    ''' <param name="cleanPath">If true, the path will be trimmed of white space, leading and ending "\", and all "\\".</param>
    ''' <remarks></remarks>
    Public Shared Function GetSingleXMLNodeListValues(ByVal pPath As String, ByVal pPathNode As String, Optional ByVal pPathNodeAttrib As String = "", Optional ByVal cleanPath As Boolean = False) As ObservableCollection(Of String)
...
#Region "Reading/Writing Node Lists"
    ...
    ''' <returns>Node value or node attribute value.</returns>
    ''' <remarks></remarks>
    Public Shared Function ReadNodeListText(ByVal pathNode As String, ByRef myList As ObservableCollection(Of String), Optional ByVal pathNodeAttrib As String = "") As Boolean
        Dim i As Integer
    ...
    ''' <remarks></remarks>
    Public Shared Sub WriteNodeListText(ByVal propValue As String(), ByVal pathNode As String, ByVal nameListNode As String)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadNodeListPath(ByVal p_pathNode As String,
                                            Optional ByVal p_relativeToProgram As String = "") As ObservableCollection(Of String)
    ...
    ''' <param name="p_relativeToProgram">If base reference is relative to the program, specify the relative path difference with this parameter.</param>
    ''' <remarks></remarks>
    Public Shared Sub WriteNodeListPath(ByVal p_pathNode As String,
                                        ByVal p_nameListNode As String,
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadUniqueList(ByVal p_pathNode As String) As ObservableCollection(Of String)
        Dim myList As New ObservableCollection(Of String)
    ...
    ''' <remarks></remarks>
    Public Shared Sub WriteUniqueList(ByVal p_pathNode As String,
                                      ByVal p_nameListNode As String,
    ...
    ''' <remarks></remarks>
    Public Shared Sub WriteSingleXMLNodeValue(ByVal p_path As String,
                                              ByVal p_pathNode As String,
...
#Region "Reading/Writing Node Objects"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadXmlObjectText(ByVal tagName As String, ByVal singleNodePath As String, Optional ByRef myList As ObservableCollection(Of String) = Nothing, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetResultsNodeList(ByVal p_tagName As String,
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetNodeList(ByRef nodeList As XmlNodeList, ByVal tagName As String, ByVal useNameSpace As Boolean, Optional ByVal nameSpaceURI As String = "", Optional ByVal parentNodes As List(Of String) = Nothing) As Boolean
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function SelectSingleNode(ByVal node As XmlNode, ByVal singleNodePath As String, ByVal useNameSpace As Boolean, Optional nsmgr As XmlNamespaceManager = Nothing, Optional ByVal attributeName As String = "") As String
        Dim nodeValue As String = ""
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ConfirmationNodeExists(ByVal confirmationNode As String, ByVal useNameSpace As Boolean, ByVal nsmgr As XmlNamespaceManager, ByVal nodeList As XmlNodeList) As Boolean
        Try
    ...
    ''' <remarks></remarks>
    Public Shared Sub UpdateObjectByTag(ByVal tagName As String, ByVal lookupNodePath As String, ByVal writeNodePath As String, ByVal nodeValueLookup As String, ByVal nodeValueWrite As String, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadXmlObjectTextSubTag(ByVal tagName As String, ByVal tagIdentifier As String, ByVal tagIdentifierValue As String, ByVal singleNodePath As String, ByRef myList As ObservableCollection(Of String), Optional ByVal singleNodePathParent As String = "", _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ReadXmlObjectTextSubSubTag(ByVal tagName As String, ByVal subTagName As String, ByVal subSubTagName As String, ByVal singleNodePath As String, ByRef myList As ObservableCollection(Of String)) As String
        Dim nodeValue As String
    ...
    ''' <remarks></remarks>
    Public Shared Function ListObjectByKey(ByVal pathNode As String, ByVal keyNodeValue As String, ByVal lookupNodeName As String) As String
    ...
    ''' <remarks></remarks>
    Public Shared Sub ReadXmlSettingsObject(ByVal pathNode As String, ByVal myObjectType As eXMLSettingsObjectType)
...
#Region "Reading/Writing Specific Cases"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function UpdateUniqueModelIDList(Optional ByVal resultsPath As String = "") As List(Of String)
        Dim tempList As New List(Of String)
    ...
    ''' <remarks></remarks>
    Public Shared Sub HandleZeroTolerance(ByVal nodeIndex As Integer, ByVal resultType As eResultType, Optional ByVal attributeValue As String = "1", Optional ByVal overWriteExisting As Boolean = True)
    ...
    ''' <remarks></remarks>
    Public Shared Function GetXMLNodeObjectValuePairs(ByVal myXMLPath As String, ByVal pathNode As String, _
...
#Region "Creating/Inserting/Deleting Nodes"
    ...
    ''' <remarks></remarks>
    Public Shared Sub CreateNodeByPath(ByVal pathNode As String, ByVal nameNode As String, ByVal valueNode As String, _
    ...
    ''' <remarks></remarks>
    Public Shared Sub DeleteNodeByPath(ByVal pathNode As String, Optional ByVal pathNodeAttrib As String = "")
        'Create an XmlNamespaceManager for resolving namespaces.
        Dim nsmgr As New XmlNamespaceManager(xmlDoc.NameTable)
        nsmgr.AddNamespace("n", xmlDoc.DocumentElement.NamespaceURI)
        myXMLNode = xmlRoot.SelectSingleNode(pathNode, nsmgr)
    ...
    ''' <param name="typeNode">New node type.</param>
    ''' <remarks></remarks>
    Public Shared Sub CreateNodeInXMLFile(ByVal myPath As String, ByVal pathNode As String, ByVal nameNode As String, ByVal valueNode As String, _
                            ByVal typeNode As eXMLElementType, ByVal createMethod As eNodeCreate)
        Try
            If InitializeXML(myPath) Then
    ...
    ''' <remarks></remarks>
    Public Shared Sub DeleteNodeInXMLFile(ByVal myPath As String, ByVal deleteNodePath As String, Optional ByVal deleteNodeAttribute As String = "")
        Try
            If InitializeXML(myPath) Then
...
#Region "Creating Node Objects"
    ...
    Public Shared Sub CreateObjectImage(ByVal p_pathNode As String,
                                        ByVal p_images As ObservableCollection(Of cFileAttachment))
        Dim objXMLNodeHeader As XmlNode
        Dim objXMLNode As XmlNode
        Dim myNameSpace As String
    ...
    ''' <remarks></remarks>
    Public Shared Sub CreateObjectUpdate(ByVal p_pathNode As String,
...
#Region "Mirror XML Functions Into Memory"
    ...
    ''' <remarks></remarks>
    Public Shared Sub MirrorAllEditorXMLS(Optional ByVal myXMLPathList As List(Of String) = Nothing,
    ...
    ''' <remarks></remarks>
    Public Shared Function mirrorXMLElementsAll(ByVal p_xmlFilePath As String) As cXMLObject
    ...
    ''' <remarks></remarks>
    Public Shared Sub Mirror_ChildNodes(ByVal myPath As String, ByRef myChildLevel As Integer, ByVal myChildNodes As XmlNodeList, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function IsMatchingHeaderWithoutChildren(ByVal p_xmlNode As cXMLNode,
    ...
    ''' <remarks></remarks>
    Public Shared Sub CreateMirrorNode(ByVal p_nodePath As String,
    ...
    ''' <remarks></remarks>
    Public Shared Function UpdateXMLFile(ByVal myPath As String, ByRef myXMLCollection As ObservableCollection(Of cXMLNode)) As Boolean
        Dim ChildLevel As Integer = 1
    ...
    Public Shared Sub UpdateXMLFileNodes(ByRef myChildLevel As Integer, ByVal myChildNodes As XmlNodeList, ByRef myCounter As Integer, ByRef myXMLCollection As ObservableCollection(Of cXMLNode), Optional ByVal myCounterTemp As Integer = -2)
