...
// ***********************************************************************
// <copyright file="DesignDetailing.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design
{
    ...
    public class DesignDetailing : CSiApiBase, IDesignDetailing
    {
        ...
        {
            _callCode = _sapModel.Detailing.GetBeamLongRebarData(name,
                            ref numberOfRebarSets,
                            ref barSizeNames,
                            ref barAreas,
                            ref numberOfBars,
                            ref locations,
                            ref clearCovers,
                            ref startCoordinates,
                            ref barLengths,
                            ref bendingAnglesStart,
                            ref bendingAnglesEnd,
                            ref rebarSetGUIDs);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.Detailing.GetBeamTieRebarData(name,
                            ref numberOfRebarSets,
                            ref barSizeNames,
                            ref barAreas,
                            ref numberLegs,
        ...
        public void GetColumnLongitudinalRebarData(string name,
            ...
            ref string[] rebarSetGUID)
        {
            _callCode = _sapModel.Detailing.GetColumnLongRebarData(name,
                            ref numberOfRebarSets,
                            ref barSizeNames,
                            ref barAreas,
                            ref numberOfCBars,
        ...
        public void GetColumnTieRebarData(string name,
            ...
            ref string[] rebarSetGUID)
        {
            int[] csiPattern = new int[0];
            int[] csiConfineType = new int[0];

            _callCode = _sapModel.Detailing.GetColumnTieRebarData(name,
                                ref numberOfRebarSets,
                                ref barSizeNames,
                                ref barAreas,
                                ref csiPattern,
                                ref csiConfineType,
                                ref numberOfLegs2Dir,
                                ref numberOfLegs3Dir,
                                ref locations,
                                ref clearCovers,
                                ref startCoordinates,
                                ref spacings,
            ...
            pattern = new eRebarConfiguration[numberOfRebarSets];
            confineType = new eConfinementType[numberOfRebarSets];
            for (int i = 0; i < numberOfRebarSets; i++)
            {
                pattern[i] = (eRebarConfiguration)csiPattern[i];
                confineType[i] = (eConfinementType)csiConfineType[i];
            }
        }
        ...
        public void GetDetailedBeamLineData(string beamLineID,
            ...
            ref int[] tieBarTypes)
        {
            _callCode = _sapModel.Detailing.GetDetailedBeamLineData(beamLineID,
                                ref objectUniqueNames,
                                ref numberOfSpans,
                                ref spanLength,
                                ref numberOfLongitudinalBars,
                                ref longitudinalBarDiameters,
                                ref longitudinalBarNotations,
                                ref longitudinalBarStartDistances,
                                ref longitudinalBarStartBends,
                                ref longitudinalBarEndBends,
                                ref longitudinalBarLengths,
                                ref longitudinalBarNumberOfLayers,
                                ref numberOfTieBars,
                                ref numberOfTieVerticalLegs,
                                ref tieBarDiameters,
                                ref tieBarNotations,
                                ref tieBarStartDistances,
                                ref tieBarSpacings,
                                ref tieBarTypes);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.Detailing.GetDetailedBeamLines(ref _numberOfItems,
                                ref beamLineIDs);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void GetDetailedColumnStackData(string columnStackID,
            ...
            ref int[] tieBarTypes)
        {
            _callCode = _sapModel.Detailing.GetDetailedColumnStackData(columnStackID,
                                ref objectUniqueNames,
                                ref numberOfRebarSets,
                                ref numberOfLongitudinalBars,
                                ref longitudinalBarDiameters,
        ...
        {
            _callCode = _sapModel.Detailing.GetDetailedColumnStacks(ref _numberOfItems,
                            ref columnStackIDs);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void GetDetailedSlabBottomBarData(string slabName,
            ...
            ref string[] GUIDs)
        {
            _callCode = _sapModel.Detailing.GetDetailedSlabBotBarData(slabName,
                            ref _numberOfItems,
                            ref names,
                            ref numberOfBars,
                            ref barDiameters,
        ...
        public void GetDetailedSlabBottomBarData(string slabName,
            ...
            ref int[] spanNumbers)
        {
            _callCode = _sapModel.Detailing.GetDetailedSlabBotBarData_1(slabName,
                            ref _numberOfItems,
                            ref names,
                            ref numberOfBars,
                            ref barDiameters,
        ...
        public void GetDetailedSlabs(ref string[] names,
            ...
            ref string[] GUIDs)
        {
            _callCode = _sapModel.Detailing.GetDetailedSlabs(ref _numberOfItems,
                ref names,
                ref slabElevations,
                ref GUIDs);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        public void GetDetailedSlabTopBarData(string slabName,
            ...
            ref string[] GUIDs)
        {
            _callCode = _sapModel.Detailing.GetDetailedSlabTopBarData(slabName,
                                ref _numberOfItems,
                                ref names,
                                ref numberOfBars,
                                ref barDiameters,
        ...
        public void GetDetailedSlabTopBarData(string slabName,
            ...
            ref int[] spanNumbers)
        {
            _callCode = _sapModel.Detailing.GetDetailedSlabTopBarData_1(slabName,
                                ref _numberOfItems,
                                ref names,
                                ref numberOfBars,
                                ref barDiameters,
        ...
        public void GetSimilarBeamLines(string beamLineID,
            ...
            ref string[] objectUniqueNames)
        {
            _callCode = _sapModel.Detailing.GetSimilarBeamLines(beamLineID,
                ref numberOfSimilarBeams,
                ref numberOfUniqueObjects,
                ref objectUniqueNames);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void GetSimilarColumnStacks(string columnStackID,
            ...
            ref string[] objectUniqueNames)
        {
            _callCode = _sapModel.Detailing.GetSimilarColumnStacks(columnStackID, 
                ref numberOfSimilarColumns,
                ref numberOfUniqueObjects,
                ref objectUniqueNames);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void GetSimilarSlabs(string slabName,
            ...
            ref string[] names)
        {
            _callCode = _sapModel.Detailing.GetSimilarSlabs(slabName, ref numberOfSimilarSlabs, ref names);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        #endregion
    }
